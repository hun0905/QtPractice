...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(80, 20, 661, 521));
        ...
        pushButton_seg = new QPushButton(layoutWidget);
        ...
        pushButton_len = new QPushButton(layoutWidget);
        ...
        pushButton_add_p = new QPushButton(layoutWidget);
